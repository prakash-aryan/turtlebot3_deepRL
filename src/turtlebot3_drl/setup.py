...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/eval', [os.path.join('turtlebot3_drl', 'eval', 'scenarios.yaml')]),
    ],
    ...
    entry_points={
        'console_scripts': [
            ...
            'eval_agent = turtlebot3_drl.eval.eval_runner:main',
            'real_agent = turtlebot3_drl.drl_agent.drl_agent:main_real',
            'path_publisher = turtlebot3_drl.utility.path_publisher:main',
            'gt_tf_publisher = turtlebot3_drl.utility.gt_tf_publisher:main',
        ],
    },
)
